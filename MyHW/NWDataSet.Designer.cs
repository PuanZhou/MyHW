...
SELECT ProductID, ProductName, SupplierID, CategoryID, QuantityPerUnit, UnitPrice, UnitsInStock, UnitsOnOrder, ReorderLevel, Discontinued FROM Products WHERE (ProductID = @ProductID)";
        ...
        private void InitCommandCollection() {
            ...
            this._commandCollection[1].CommandText = "SELECT ProductID, ProductName, SupplierID, CategoryID, QuantityPerUnit, UnitPrice" +
                ...
                " Unitprice between @UPL and @UPH";
            this._commandCollection[1].CommandType = global::System.Data.CommandType.Text;
            this._commandCollection[1].Parameters.Add(new global::System.Data.SqlClient.SqlParameter("@UPL", global::System.Data.SqlDbType.Money, 8, global::System.Data.ParameterDirection.Input, 0, 0, "UnitPrice", global::System.Data.DataRowVersion.Current, false, null, "", "", ""));
            this._commandCollection[1].Parameters.Add(new global::System.Data.SqlClient.SqlParameter("@UPH", global::System.Data.SqlDbType.Money, 8, global::System.Data.ParameterDirection.Input, 0, 0, "UnitPrice", global::System.Data.DataRowVersion.Current, false, null, "", "", ""));
            ...
            this._commandCollection[2].Parameters.Add(new global::System.Data.SqlClient.SqlParameter("@producName", global::System.Data.SqlDbType.NVarChar, 40, global::System.Data.ParameterDirection.Input, 0, 0, "ProductName", global::System.Data.DataRowVersion.Current, false, null, "", "", ""));
        }
        ...
        public virtual int FillByPrice(NWDataSet.ProductsDataTable dataTable, global::System.Nullable<decimal> UPL, global::System.Nullable<decimal> UPH) {
            this.Adapter.SelectCommand = this.CommandCollection[1];
            if ((UPL.HasValue == true)) {
                this.Adapter.SelectCommand.Parameters[0].Value = ((decimal)(UPL.Value));
            }
            else {
                this.Adapter.SelectCommand.Parameters[0].Value = global::System.DBNull.Value;
            }
            if ((UPH.HasValue == true)) {
                this.Adapter.SelectCommand.Parameters[1].Value = ((decimal)(UPH.Value));
            }
            else {
        ...
        public virtual NWDataSet.ProductsDataTable GetDataByPrice(global::System.Nullable<decimal> UPL, global::System.Nullable<decimal> UPH) {
            this.Adapter.SelectCommand = this.CommandCollection[1];
            if ((UPL.HasValue == true)) {
                this.Adapter.SelectCommand.Parameters[0].Value = ((decimal)(UPL.Value));
            }
        ...
        [global::System.ComponentModel.Design.HelpKeywordAttribute("vs.data.TableAdapter")]
        [global::System.ComponentModel.DataObjectMethodAttribute(global::System.ComponentModel.DataObjectMethodType.Fill, false)]
        public virtual int FillByProductName(NWDataSet.ProductsDataTable dataTable, string producName) {
            this.Adapter.SelectCommand = this.CommandCollection[2];
            if ((producName == null)) {
                throw new global::System.ArgumentNullException("producName");
            }
            else {
                this.Adapter.SelectCommand.Parameters[0].Value = ((string)(producName));
            }
            if ((this.ClearBeforeFill == true)) {
                dataTable.Clear();
            }
        ...
        [global::System.ComponentModel.Design.HelpKeywordAttribute("vs.data.TableAdapter")]
        [global::System.ComponentModel.DataObjectMethodAttribute(global::System.ComponentModel.DataObjectMethodType.Select, false)]
        public virtual NWDataSet.ProductsDataTable GetDataByProductName(string producName) {
            this.Adapter.SelectCommand = this.CommandCollection[2];
            if ((producName == null)) {
                throw new global::System.ArgumentNullException("producName");
            }
